...
- **التكامل مع المحرر:** عند اختيار فتحها في المحرر تُنشأ صورة الناتج كمقطع جديد في مشروع VideoForgeNative وتُحفظ بيانات المشروع عبر `ProjectRepository`.
- **المعالجة:** مجانية ومحلية حاليًا، تعتمد على تحويلات ألوان/بكسلة؛ ليست نموذج توليد AI سحابيًا.
- **الاختبار:** هذه الدفعة لم تُختبر بعد ببناء CI جديد؛ لذلك الحالة النهائية للميزة ما زالت تحتاج Compile/Lint واختبار جهاز فعلي.
